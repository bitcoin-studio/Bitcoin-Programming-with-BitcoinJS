...
On the February 23, 2017, someone successfully claimed the SHA-1 hash collision bounty of 2.48 BTC, with this transaction https://blockstream.info/tx/8d31992805518fd62daa3bdd2a5c4fd2cd3054c9b3dca1d78055e9528cff6adc[8d31992805518fd62daa3bdd2a5c4fd2cd3054c9b3dca1d78055e9528cff6adc]

____

To read more about Bitcoin computational puzzles and Peter Todd bounties

* https://bitcointalk.org/index.php?topic=293382.0["REWARD offered for hash collisions for SHA1, SHA256, RIPEMD160 and other"]
* https://github.com/ChristopherA/Learning-Bitcoin-from-the-Command-Line/blob/master/11_1_Writing_Puzzle_Scripts.md[Christopher Allen Guide - Writing Puzzle Scripts]
...
Continue "Part Three: Pay To Script Hash" with link:../multi_signatures/[Multi-signature Transactions].