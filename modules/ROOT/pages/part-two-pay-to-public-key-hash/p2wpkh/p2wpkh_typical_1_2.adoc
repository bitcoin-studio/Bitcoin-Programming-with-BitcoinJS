...
<2> First output locking 0.5 btc to bob_1 P2WPKH recipient address
<3> Second output locking 0.499 btc to alice's change address. Alice uses the same address for simplicity but an other one would offer
better privacy
